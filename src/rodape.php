<footer class="footer" style="position: fixed; bottom: 0; width: 100%; background-color:rgb(17, 18, 18); padding: 1rem 0; border-top: 1px solidrgb(0, 0, 0);">
    <div class="content has-text-centered">
        ...
        <p>
            O código-fonte está licenciado sob <a href="#" target="_blank">IFC</a>. O conteúdo do site está licenciado sob 
            <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/" target="_blank">CC BY NC SA 4.0</a>.
        </p>
        <p>
            &copy; <?php echo date('Y'); ?> Biblioteca Dirigida. Todos os direitos reservados.
        </p>
    </div>
</footer>